...
import '../Style/studentcontent/studentdashboard.css' ;
...
function Studentdashboard({setStudentUser, setStudentsLogin, setStudentToken}){
    let handleLogout = () =>{
    ...
    return (
        <div className='container-full bg-dark w-100 h-100 p-3'>
            <div className='contents'>
            <div className='student-nav'>
                <Link to='/student' className='s-link'>
                ...
                <Link to='/studentquery' className='s-link'>
                    <SiGooglebigquery className='img fs-3'/>
                    <p>Createquery</p>
                </Link>
                <Link to='/project' className='s-link'>
                    <GoProjectSymlink className='img fs-3'/>
                    <p>Project</p>
                </Link>
                <Link to='/studentsyallabus' className='s-link'>
                    <FaDatabase className='img fs-3'/>
                    <p>Syallabus</p>
                </Link>
                <Link to='/certificate' className='s-link'>
                    <AiFillSafetyCertificate className='img fs-3' />
                    <p>Certificate</p>
                </Link>
                <Link to='/requirements' className='s-link'>
                    <MdOutlineEditCalendar className='img fs-3'/>
                    <p>Requirements</p>
                </Link>
                 <div className='s-link'>
                    <button className='p-1 bg-danger text-light rounded-2 ' style={{width:100}} onClick={handleLogout}>Logout</button>
                </div>
            </div>
           
            <div className='class bg-secondary d-flex flex-row flex-wrap p-3 oveflow-auto'>
                    <div className='buttons border bg-light p-3 flex-wrap justify-content-between rounded-3 '>
                    ...
                    <div className='bg-secondary p-3 h-50'>
                    {
                       view == 1 ? (
                    ...
                    <div>
                        {
                            view == 4 ?(
                                <div className='first border border-black bg-light p-2 w-100 rounded-2'>
